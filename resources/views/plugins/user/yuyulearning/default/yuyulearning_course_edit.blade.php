                                    ...
                                    <tbody>
                                        @foreach ($contents as $content)
                                            <tr>
                                                ...
                                                <td class="align-middle">
                                                    <span class="badge badge-light border yuyu-learning-badge">
                                                        {{ $content_type_labels[$content->content_type] ?? $content->content_type }}
                                                    </span>
                                                </td>
                                                <td class="text-center align-middle">
                                                    @if ($content->is_required)
                                                        <span class="badge badge-danger yuyu-learning-badge">必須</span>
                                                    @else
                                                        <span class="badge badge-secondary yuyu-learning-badge">任意</span>
                                                    @endif
                                                </td>
                                                <td class="text-center align-middle">
